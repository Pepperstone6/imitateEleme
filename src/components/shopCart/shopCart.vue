<template>
  <div>
    ...
    <div class="cart-wr cart-to">
      <span class="mini-cart on">
      </span>
      <div class="cart-info">
        <p class="total-price">
          <span>
      ...
      <a href="javascript:" class="js open">
        <span>￥0起送</span>
      </a>
    </div>
  </div>
